...
/**
 * Servlet implementation class UploadIfr
 */
@WebServlet("/UploadIfr")
public class UploadIfr extends HttpServlet {
...
//		response.setCharacterEncoding("utf-8");
		response.getWriter().write("<script>parent.callback_func('テスト')</script>");
